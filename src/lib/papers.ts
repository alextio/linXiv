...
// Modern arXiv IDs (YYMM.NNNNN) and legacy ones (cs/0612047, cond-mat.mes-hall/0309136);
// a dotted class must be lowercase here, unlike core formats.rs `is_arxiv_id`.
